...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/formix")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/formix/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/formix/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/formix.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/formix.git")
            }
        }
    }
}